    ...
    loadXMLDoc('GET', mystring, function (response) {
      ...
      <div class="myChartContainer" id="chartDiv" style="display:inline-block;"></div>';
            ...
            for (var i = 0; i < rest.length-1; i++) {
                var tmp=rest[i].split("<>");
                for(var j=0;j<tmp.length-1;j=j+4){
                     document.getElementById("chartDiv").innerHTML = document.getElementById("chartDiv").innerHTML + '<span style="display:block;text-align:center;">' + tmp[j] + '</span>';
                }
